...
| [**CVE-2011-0419**](http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2011-0419) | Дозволяє викликати відмову в обслуговуванні (DoS) через використання спеціально сформованих регулярних виразів у запитах, що спричиняють високі витрати CPU і пам’яті. Ця проблема впливає на модуль `mod_autoindex`. | [](https://www.exploit-db.com/exploits/35738) |
